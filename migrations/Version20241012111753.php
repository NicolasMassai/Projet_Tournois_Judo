 ...
 */
final class Version20241012111753 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adherant_categorie (adherant_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_E413DD96BE612E45 (adherant_id), INDEX IDX_E413DD96BCF5E72D (categorie_id), PRIMARY KEY(adherant_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
